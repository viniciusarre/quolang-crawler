...
class TestCrawler(unittest.TestCase):
    ...
    def test_url_set_up_case01(self):
        ...
        self.assertEqual(test_data["result"]["data"][0]["quotes"], citations_expect)
        self.assertEqual(test_data["result"]["data"][0]["source"], sources_expect)
